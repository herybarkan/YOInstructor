                        ...
                        <div class="vc_column-inner">
                           <div class="wpb_wrapper">
                              <div role="form" class="wpcf7" id="wpcf7-f1050-p1258-o3" lang="en-US" dir="ltr">
                                 ...
                                 <form action="modul/payment/request_upgrade.php" method="post" class="wpcf7-form init cf7_custom_style_1" novalidate="novalidate">
...
$drm= date('Y-m-d', strtotime($date. ' + 21 days')); 
						...
						//echo $final."<br>";
						?>
                        <input type="hidden" name="item_name" value="Upgrade Account,<?php echo $_GET['kd_inst'].","; ?><?php echo $datenow.","; ?><?php echo $final.","; ?><?php echo $drm.","; ?>" id="item_name">
                    ...
                    <!--<a href="?com=fpayment_bt&kd_inst=<?php //echo $_SESSION['yo_kd_user']; ?>"><input name="bnp" type="button" value="Pay with Bank Transfer" class="btn" style="background-color:#000; color:#FFF; width:270px; height:50px; margin-top:-10px;"/></a>-->
