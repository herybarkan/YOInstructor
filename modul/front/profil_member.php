...
?>
                ...
                <div class="group-9">
                  ...
                  <img class="ic-share" src="img/icshare@2x.png" />
                </div>
              </div>
            </div>
...
<input name="p1" id="p1" type="text" value="<?php echo $row_prc['price1']; ?>"/>
</div>
<div style="width:200px; display:inline-block;">
5 Session Price
<input name="p2" id="p2" type="text" value="<?php echo $row_prc['price2']; ?>"/>
</div>
<div style="width:200px; display:inline-block;">
10 Session Price
<input name="p3" id="p3" type="text" value="<?php echo $row_prc['price3']; ?>"/>
</div>
         ...
         <div class="edgtf-tabs  ui-tabs ui-widget ui-widget-content ui-corner-all" style="border:0px;">
            <ul class="edgtf-tabs-nav clearfix ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
               ...
               <li class="ui-state-default ui-corner-top  ui-tabs-active ui-state-active" role="tab" tabindex="-1" aria-controls="tab-specs-138" aria-labelledby="ui-id-1" aria-selected="true" aria-expanded="true">
                  <a href="#tab-specs-138" class="ui-tabs-anchor btn text-white" role="presentation" tabindex="-1" id="ui-id-1" style="background-color:#FFF; border:1px; border-color:#ccc; border-radius:7px; ">Single Package</a>
               </li>
        ...
        <div class="group-45 opensans-normal-black-14px">
          ...
          <div class="group-10-6">
            ...
            <div class="group-9-6">
              ...
              <img class="ic-share-6" src="img/icshare@1x.png" />
            </div>
          </div>
<?php
  if ($_SESSION['yo_grup']!="4" && $_SESSION['yo_uname']!="")      { ?>            
      ...
      <div class="wpb_wrapper">
         <div class="edgtf-tabs  ui-tabs ui-widget ui-widget-content ui-corner-all" style="border:0px;">
            <ul class="edgtf-tabs-nav clearfix ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all" role="tablist">
               ...
               <li class="ui-state-default ui-corner-top  ui-tabs-active ui-state-active" role="tab" tabindex="-1" aria-controls="tab-specs-138" aria-labelledby="ui-id-1" aria-selected="true" aria-expanded="true">
                  <a href="#tab-specs-138" class="ui-tabs-anchor btn text-white btn-sm" role="presentation" tabindex="-1" id="ui-id-1" style="background-color:#FFF; border:1px; border-color:#ccc; border-radius:7px; width:100%; margin-left:15px;">Single Package</a>
               </li>
               <li class="ui-state-default ui-corner-top" role="tab" tabindex="0" aria-controls="tab-trophies-549" aria-labelledby="ui-id-2" aria-selected="false" aria-expanded="false">
...
<div id="result_price2">
            <div class="edgtf-tab-container ui-tabs-panel ui-widget-content ui-corner-bottom" id="tab-specs-138" aria-labelledby="ui-id-1" role="tabpanel" aria-hidden="true" style="display: none;">
               ...
               <div class="group-56" style="width:100%;">
                <div class="surname opensans-semi-bold-black-15px">PRICE</div>
                <div class="price montserrat-bold-black-24px"><?php echo $row_prcm['currency']; ?> <?php echo number_format($row_prcm['price1'],0,",","."); ?></div>
              </div>
            ...
            <div class="edgtf-tab-container ui-tabs-panel ui-widget-content ui-corner-bottom" id="tab-trophies-549" aria-labelledby="ui-id-2" role="tabpanel" aria-hidden="false" style="display: inline-block;">
               ...
               <div class="group-56" style="width:100%;">
                <div class="surname opensans-semi-bold-black-15px">PRICE</div>
                <div class="price montserrat-bold-black-24px"><?php echo $row_prcm['currency']; ?> <?php echo number_format($row_prcm['price2'],0,",","."); ?></div>
              </div>
            ...
            <div class="edgtf-tab-container ui-tabs-panel ui-widget-content ui-corner-bottom" id="tab-achievements-932" aria-labelledby="ui-id-3" role="tabpanel" aria-hidden="true" style="display: none;">
               <div class="group-56" style="width:100%;">
                <div class="surname opensans-semi-bold-black-15px">PRICE</div>
                <div class="price montserrat-bold-black-24px"><?php echo $row_prcm['currency']; ?> <?php echo number_format($row_prcm['price3'],0,",","."); ?></div>
              </div>
            </div>
...
<div style="width:200px; display:inline-block;">
Single Package Price
<input name="p12" id="p12" type="text" value="<?php echo $row_prc['price1']; ?>"/>
</div>
<div style="width:200px; display:inline-block;">
5 Session Price
<input name="p22" id="p22" type="text" value="<?php echo $row_prc['price2']; ?>"/>
</div>
<div style="width:200px; display:inline-block;">
10 Session Price
<input name="p32" id="p32" type="text" value="<?php echo $row_prc['price3']; ?>"/>
</div>
                  ...
                  <div class="edgtf-ls-amenities-items">
                     <div class="edgtf-ls-amenities-items" style="column-count:2; padding-left:15px;">
                        ...
                        <div class="edgtf-ls-combined-item">
                           <a itemprop="url" class="edgtf-ls-amenity edgtf-ls-included-item" href="#">
                           <input name="cb_who2[]" id="cb_who2[]" type="checkbox" value="<?php echo $row_wt2['nm_train']; ?>" <?php echo $ckd; ?>/>
...
<!--=============================================================================================-->              
            ...
            <div class="group-51">
              ...
              <div class="group-33-4">
                ...
                <br>
                <!--<img class="before-img-1" src="img/beforeimg@1x.png" />
                <img class="after-img-1" src="img/afterimg@1x.png" />-->
<div id="d_post2">   
            ...
            <div class="group-53">
              ...
              <div class="group-34-1" style="margin-left:20px;">
                ...
                <div class="group-39-1">
                  <!--<div class="total-113-riviews opensans-bold-black-13px">Total 113 Riviews</div>-->
                  <?php
                                    $select_stmt_comment=$db->prepare("SELECT * FROM instructor_review WHERE kd_instructor='$_GET[kd_inst]'");	//sql select query
                                    $select_stmt_comment->execute();
                                    while($row_comment=$select_stmt_comment->fetch(PDO::FETCH_ASSOC))
                                    {
                                    ?>
                  <div class="group-34-2">
                    <img class="pic-dummy1" src="foto/member/<?php echo $row_comment['images']; ?>" />
                    <div class="group-30-6">
                      <img class="group-5-6" src="img/group-5-1@2x.svg" />
                      <div class="name-9"><?php echo $row_comment['nm_member']; ?> </div>
                      <div class="address-1"><?php echo $row_comment['tgl']; ?></div>
                      <p class="text-16 opensans-normal-black-13px">
                        <?php echo $row_comment['koment']; ?>
                      </p>
                    </div>
                  </div>
                  <?php } ?>
