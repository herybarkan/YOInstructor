                     ...
                     <div class="tab-content" style="min-height:0px;">
                        <div class="tab-pane" id="bio">
                           <div class="row">
                              ...
                              <h4 class="info-text"> <span style="color:#F00;">There is an error.</span><br>
please check your email again and make sure your account is still active</h4>
                     ...
                     <div class="wizard-footer">
                       ...
                       <!-- <div class="pull-right">-->
                          ...
                          <center> 
                          <a href="index.php?com=lost_password">
                           <input type='button' class='btn btn-finish btn-fill btn-wd' name='finish' value='TRY AGAIN' data-color="yellow" style="background-color:#FC0;"/>
                           </a>
                           </center>
                       <!-- </div>-->
