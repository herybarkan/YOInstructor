...
<html lang="en">
	<head>
		...
		<!-- Meta -->
		<meta name="description" content="YO Admin">
		<meta name="author" content="YO Admin">
		<link rel="shortcut icon" href="img/faveicon.png" />

		<!-- Title -->
		<title>YO Admin</title>
	...
	<body>
		...
		<div id="loading-wrapper">
			<!--<div class="spinner-border" role="status">-->
				<!--<span class="sr-only" style="color:#FFF;">Loading...</span>-->
                
			<!--</div>
            <span style="color:#FFF; font-size:36px;">xxx</span>-->
			...
			<nav id="sidebar" class="sidebar-wrapper">
				...
				<div class="sidebar-brand">
					<a href="index.php" class="logo">
						<img src="img/logo.png" alt="YO Admin" />
					</a>
				</div>
			<?php
				//
					if ($_SESSION['yo_grup']=="1") {include ('modul/menu/sidebar.php');}
		...
		<div class="page-content">
			...
			<div class="main-container">
				<?php
					...
					if ($_GET['com']=="")
					{
						if ($_SESSION['yo_grup']=="1") {include ('modul/dashboard/dashboard_sa.php');}
					elseif ($_SESSION['yo_grup']=="2") {include ('modul/dashboard/dashboard_staff.php');}
...
<?php
if ($_SESSION['yo_uname']=="") {header("refresh:0; ../index.php?sts_login=fail");}
?>
