...
<div class="edgtf-container-inner clearfix fotox" style="margin-top:10px; height:100%; ">
   ...
   <div id="product-477" class="post-477 product type-product status-publish has-post-thumbnail product_cat-food product_tag-breakfast product_tag-healthy first instock sale shipping-taxable purchasable product-type-simple" style="height:700px;">
...
<div id="result_contact">       
            ...
            <div class="group-32 opensans-normal-black-16px" style="margin-top:20px;">
               ...
               <div class="text-54"><a href="tel:<?php echo $row['phone_number']; ?>"><?php echo $row['phone_number']; ?></a><br>
...
<!--<span style="width:<?php //echo $xval; ?>">Rated <strong class="rating"></strong> out of 5</span></div>-->
                              <p class="meta">
