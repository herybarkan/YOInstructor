   ...
   <div class="edgtf-title-wrapper" style="height: 375px">
      <div class="edgtf-title-inner">
         <div class="edgtf-grid">
            ...
            <span class="font_hitam">ORDER</span> <span class="font_kuning">FORM</span>
         </div>
      </div>
   </div>
</div>
				 ...
				 { ?> 
                  <div class="wpb_text_column wpb_content_element ">
                  	<div class="wpb_wrapper">
						...
						?>
                        <input type="hidden" name="item_name" value="<?php echo $pkg.","; ?><?php echo $_GET['kd_inst'].","; ?><?php echo $_SESSION['yo_kd_user'].","; ?><?php echo $_GET['tgl']. ",".$_GET['hari'].","; ?><?php echo $_GET['js']. ",".$_GET['je']; ?>" id="item_name">
                        <h4>
                        <?php echo $pkg; ?><br>
                    ...
                    <h4>
                    <?php echo $_GET['tgl']. " ".$_GET['hari']; ?> <br>
                    <?php echo $_GET['js']. " ".$_GET['je']; ?>
                    </h4>
                    Your Notes
                    <textarea name="catatan" cols="" rows="3"></textarea>
                    
                    <input name="bnp" type="submit" value="Book &amp; Pay" class="btn" style="background-color:#FFE45F;"/><br><br>
