...
function(T) {
	...
	function t() {
		var e, t, a;
		u().init(), s().init(), T("#edgtf-back-to-top").on("click", function(e) {
		...
		}), l(), D(), A(), m(), (e = T(".edgtf-preload-background")).length && e.each(function() {
			var e = T(this);
		...
		}), f(), (t = T(".edgtf-search-post-type")).length && t.each(function() {
			var e = T(this),
			...
			t.on("keyup paste", function() {
				...
				a.attr("autocomplete", "off"), d.removeClass("edgtf-hidden"), n.addClass("edgtf-hidden"), clearTimeout(i), i = setTimeout(function() {
					var e = a.val();
					if (e.length < 3) o.html(""), o.fadeOut(), d.addClass("edgtf-hidden"), n.removeClass("edgtf-hidden");
					else {
						var t = {
		...
		}), (a = T(".edgtf-dashboard-form")).length && a.each(function() {
			var e = T(this),
			...
			e.on("submit", function(e) {
				e.preventDefault();
				var a = d.html(),
					t = T(this).find(".edgtf-dashboard-gallery-upload-hidden"),
					l = [];
				d.html(n);
				var f = new FormData;
				t.each(function() {
					...
					for (var r = 0; r < d.length; r++) 1 === d[r].name.match(/\./g).length && -1 !== T.inArray(d[r].type, ["image/png", "image/jpg", "image/jpeg", "application/pdf"]) && f.append(e + r, d[r])
				}), f.append("action", s);
				var o = T(this).serialize();
				return f.append("data", o), T.ajax({
					type: "POST",
					data: f,
					contentType: !1,
					processData: !1,
					...
					success: function(e) {
						var t;
						t = JSON.parse(e), edgtf.modules.socialLogin.edgtfRenderAjaxResponseMessage(t), "success" === t.status ? (d.html(i), window.location = t.redirect) : d.html(a)
					}
				}), !1
			})
		}), g()
			...
			function() {
				if (edgtf.body.hasClass("edgtf-smooth-page-transitions")) {
					if (edgtf.body.hasClass("edgtf-smooth-page-transitions-preloader")) {
						var t = T("body > .edgtf-smooth-transition-loader.edgtf-mimic-ajax");
						t.fadeOut(600, "easeOutCubic"), T(window).on("bind", "pageshow", function(e) {
							e.originalEvent.persisted && t.fadeOut(600, "easeOutCubic")
						})
					}
	...
	function i(e) {
	...
	}(edgtf.modules.common = e).edgtfFluidVideo = A, e.edgtfEnableScroll = function() {
	...
	}, e.edgtfOwlSlider = m, e.edgtfInitParallax = W, e.edgtfInitSelfHostedVideoPlayer = l, e.edgtfSelfHostedVideoSize = D, e.edgtfPrettyPhoto = f, e.edgtfStickySidebarWidget = h, e.getLoadMoreData = function(e) {
		var t = e.data(),
			a = {};
		...
		return {
			init: function(e) {
				var t;
				e.length && (t = new PerfectScrollbar(e.selector, a), T(window).resize(function() {
					t.update()
				}))
			}
		}
	}, e.edgtfToggleHoverClasses = function(e, t, a) {
		var o = T(e).find(t);
		T(e).find(a).on("mouseenter", function() {
			T(this).closest(o).addClass("edgtf-hovered")
		}).on("mouseleave", function() {
			T(this).closest(o).removeClass("edgtf-hovered")
		})
	}, e.edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowResize = o, T(document).ready(t), T(window).load(a), T(window).resize(o);
	var s = function() {
		var i = function(t) {
				T(".edgtf-main-menu, .edgtf-mobile-nav, .edgtf-fullscreen-menu").each(function() {
					var e = T(this);
			...
			o = function(e) {
				var t, a = T(".edgtf-main-menu a, .edgtf-mobile-nav a, .edgtf-fullscreen-menu a"),
					o = e,
					d = "" !== o ? T('[data-edgtf-anchor="' + o + '"]') : "";
				if ("" !== o && 0 < d.length) {
					var n = d.offset().top;
					return t = n - s(n) - edgtfGlobalVars.vars.edgtfAddForAdminBar, a.length && a.each(function() {
						var e = T(this); - 1 < e.attr("href").indexOf(o) && i(e)
		...
		return {
			init: function() {
				var t, e, a;
				T("[data-edgtf-anchor]").length && (edgtf.document.on("click", ".edgtf-main-menu a, .edgtf-fullscreen-menu a, .edgtf-btn, .edgtf-anchor, .edgtf-mobile-nav a", function() {
					var e, t = T(this),
						a = t.prop("hash").split("#")[1],
						o = "" !== a ? T('[data-edgtf-anchor="' + a + '"]') : "";
					if ("" !== a && 0 < o.length) {
						var d = o.offset().top;
						return e = d - s(d) - edgtfGlobalVars.vars.edgtfAddForAdminBar, i(t), edgtf.html.stop().animate({
							scrollTop: Math.round(e)
						}, 1e3, function() {
							history.pushState && history.pushState(null, "", "#" + a)
						}), !1
					}
				}), e = T("[data-edgtf-anchor]"), "/" !== (a = window.location.href.split("#")[0]).substr(-1) && (a += "/"), e.waypoint(function(e) {
					"down" === e && (t = 0 < T(this.element).length ? T(this.element).data("edgtf-anchor") : T(this).data("edgtf-anchor"), i(T("a[href='" + a + "#" + t + "']")))
				}, {
					offset: "50%"
				}), e.waypoint(function(e) {
					"up" === e && (t = 0 < T(this.element).length ? T(this.element).data("edgtf-anchor") : T(this).data("edgtf-anchor"), i(T("a[href='" + a + "#" + t + "']")))
				}, {
					offset: function() {
					...
					var e;
					"" !== (e = window.location.hash.split("#")[1]) && 0 < T('[data-edgtf-anchor="' + e + '"]').length && o(e)
				}))
			}
		}
	};
	...
	function r(e) {
		var t = T("#edgtf-back-to-top");
		t.removeClass("off on"), "on" === e ? t.addClass("on") : t.addClass("off")
	}

	function l() {
		var e = T(".edgtf-self-hosted-video");
	...
	function D() {
		var e = T(".edgtf-self-hosted-video-holder .edgtf-video-wrap");
	...
	function g() {
		var e = T(".edgtf-grid-masonry-list");
		e.length && e.each(function() {
			var e = T(this),
	...
	function c(e, t, a, o) {
		if (e.hasClass("edgtf-masonry-images-fixed") || !0 === o) {
			...
			i.css("height", n), r.css("height", Math.round(2 * (n + d))), 680 < edgtf.windowWidth ? (s.css("height", n), l.css("height", Math.round(2 * (n + d)))) : (s.css("height", Math.round(n / 2)), l.css("height", n))
		}
	}
	var u = function() {
		var e = T(".edgtf-icon-has-hover");
		return {
			init: function() {
				e.length && e.each(function() {
					! function(e) {
	...
	function W() {
		var e = T(".edgtf-parallax-row-holder");
		e.length && e.each(function() {
			var e = T(this),
	...
	function h() {
		var e = T(".edgtf-widget-sticky-sidebar"),
			t = T(".edgtf-page-header"),
		...
		function a() {
			u.length && T.each(u, function(e) {
				...
				if (edgtf.body.hasClass("edgtf-fixed-on-scroll")) {
					var s = T(".edgtf-fixed-wrapper.fixed");
			...
			init: function() {
				e.length && e.each(function() {
					...
					if (i = e.offset().top, s = e.position().top, l = r = 0, t.length) {
						r = t.outerHeight(), l = t.outerWidth(), d = (o = t).parent().parent().outerHeight();
						var n = t.parent().parent().find(".edgtf-blog-holder");
						n.length && (d -= parseInt(n.css("marginBottom")))
					} else a.length && (r = a.outerHeight(), l = a.outerWidth(), d = (o = a).parents(".vc_row").outerHeight());
					u.push({
						object: e,
						offset: i,
						position: s,
			...
			if (d < 3 && (S = _ = d), 4 < d && (O = 4), 5 < d && (I = 5), (h || 30 < f) && (g = 20, c = 30), 0 < f && f <= 30 && (c = g = f), t.waitForImages(function() {
					e = t.owlCarousel({
						...
						onInitialize: function() {
							t.css("visibility", "visible"), W(), (t.find("iframe").length || t.find("video").length) && setTimeout(function() {
								D(), A()
...
function(l) {
	...
	function d() {
		var e = l(".edgtf-blog-holder"),
			...
			o = function(a) {
				var o, e, d = a.children(".edgtf-blog-holder-inner");
				...
				if ((o = t.nextPage) <= e) {
					...
					var i = edgtf.modules.common.setLoadMoreAjaxData(t, "urbango_edge_blog_load_more");
					l.ajax({
						type: "POST",
						data: i,
						url: edgtfGlobalVars.vars.edgtfAjaxUrl,
						success: function(e) {
							...
							a.waitForImages(function() {
								a.hasClass("edgtf-grid-masonry-list") ? (s(d, n, t), edgtf.modules.common.setFixedImageProportionSize(a, a.find("article"), d.find(".edgtf-masonry-grid-sizer").width())) : r(d, n, t), setTimeout(function() {
	...
	}(edgtf.modules.blog = e).edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, e.edgtfOnWindowScroll = o, l(document).ready(t), l(window).load(a), l(window).scroll(o)
}(jQuery),
function(d) {
	"use strict";
	var e = {};
...
function(r) {
		...
		o(), setTimeout(function() {
			r(".edgtf-drop-down > ul > li").each(function() {
				...
				d.find(".second").length && d.waitForImages(function() {
					...
					if (d.hasClass("wide") && !edgtf.menuDropdownHeightSet && (t = e.outerHeight()), edgtf.menuDropdownHeightSet || e.height(0), navigator.userAgent.match(/(iPod|iPhone|iPad)/)) d.on("touchstart mouseenter", function() {
						e.css({
							height: t,
							overflow: "visible",
							visibility: "visible",
	...
	function o() {
		...
		e.length && e.each(function(e) {
			...
			edgtf.body.hasClass("edgtf-boxed") && (s = edgtf.boxedLayoutWidth - (o - (edgtf.windowWidth - edgtf.boxedLayoutWidth) / 2)), 0 < a.find("li.sub").length && (t = s - i), d.removeClass("right"), n.removeClass("right"), (s < i || t < i) && (d.addClass("right"), n.addClass("right"))
		})
	}
	...
	}(edgtf.modules.header = e).edgtfSetDropDownMenuPosition = o, e.edgtfSetDropDownWideMenuPosition = d, e.edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, r(document).ready(t), r(window).load(a)
}(jQuery),
function(f) {
	"use strict";
	var e = {};
	...
	function t() {
		! function() {
			var o, d = f(".edgtf-wrapper"),
				n = f(".edgtf-side-menu"),
				i = f("a.edgtf-side-menu-button-opener"),
				s = !1,
				r = !1,
				l = !1;
			edgtf.body.hasClass("edgtf-side-menu-slide-from-right") ? (f(".edgtf-cover").remove(), o = "edgtf-right-side-menu-opened", d.prepend('<div class="edgtf-cover"/>'), s = !0) : edgtf.body.hasClass("edgtf-side-menu-slide-with-content") ? (o = "edgtf-side-menu-open", r = !0) : edgtf.body.hasClass("edgtf-side-area-uncovered-from-content") && (o = "edgtf-right-side-menu-opened", l = !0);
			f("a.edgtf-side-menu-button-opener, a.edgtf-close-side-menu").on("click", function(e) {
				if (e.preventDefault(), i.hasClass("opened")) {
					if (i.removeClass("opened"), edgtf.body.removeClass(o), l) var t = setTimeout(function() {
						n.css({
							visibility: "hidden"
						}), clearTimeout(t)
					}, 400)
				} else {
					i.addClass("opened"), edgtf.body.addClass(o), s && f(".edgtf-wrapper .edgtf-cover").on("click", function() {
					...
					f(window).scroll(function() {
						if (400 < Math.abs(edgtf.scroll - a) && (edgtf.body.removeClass(o), i.removeClass("opened"), l)) var e = setTimeout(function() {
							n.css({
								visibility: "hidden"
							}), clearTimeout(e)
						}, 400)
	...
	function t() {
		...
		r(document).on("click", ".edgtf-quantity-minus, .edgtf-quantity-plus", function(e) {
				...
				var t, a = r(this),
					...
					i = !1,
					s = parseFloat(o.val());
				a.hasClass("edgtf-quantity-minus") && (i = !0), i ? 1 <= (t = s - d) ? o.val(t) : o.val(0) : (t = s + d, void 0 === n ? o.val(t) : n <= t ? o.val(n) : o.val(t)), o.trigger("change")
			}),
			function() {
...
function(u) {
	...
	function t() {
		o().init(), u(".edgtf-blog-list").length && edgtf.modules.common.edgtfToggleHoverClasses(".edgtf-blog-list", ".edgtf-bl-item", ".edgtf-post-image")
	}
	...
	function o() {
		var e = u(".edgtf-blog-list-holder"),
			...
			n = function(a, e) {
				var o, d, n = a.find(".edgtf-blog-list");
				...
				if ((o = t.nextPage) <= d) {
					...
					var s = edgtf.modules.common.setLoadMoreAjaxData(t, "urbango_edge_blog_shortcode_load_more");
					u.ajax({
						type: "POST",
						data: s,
						url: edgtfGlobalVars.vars.edgtfAjaxUrl,
						success: function(e) {
							...
							a.hasClass("edgtf-bl-pag-standard-shortcodes") ? (r(a, d, o), a.waitForImages(function() {
				...
				o === d && a.find(".edgtf-blog-pag-load-more").hide()
			},
			r = function(e, t, a) {
				...
				d.removeClass("edgtf-pag-active"), d.eq(a - 1).addClass("edgtf-pag-active"), n.data("paged", a - 1), i.data("paged", a + 1), 1 < a ? n.css({
					opacity: "1"
				}) : n.css({
					opacity: "0"
				}), a === t ? i.css({
	...
	function t() {
		! function() {
			...
			if (t.length) {
				...
				edgtf.modules.common.edgtfInitPerfectScrollbar().init(e), f(window).resize(function() {
				...
				}), edgtf.body.hasClass("edgtf-fade-push-text-right") ? (a = "edgtf-push-nav-right", o = !0) : edgtf.body.hasClass("edgtf-fade-push-text-top") && (a = "edgtf-push-text-top", d = !0), (o || d) && (n.length && n.children().css({
					...
					if (a.hasClass("has_sub")) {
						...
						d.is(":visible") ? (d.slideUp(450, "easeInOutQuint"), a.removeClass("open_sub")) : (a.addClass("open_sub"), 0 === o.length ? d.slideDown(400, "easeInOutQuint") : (a.closest("li.menu-item").siblings().find(".menu-item").removeClass("open_sub"), a.siblings().removeClass("open_sub").find(".sub_menu").slideUp(400, "easeInOutQuint", function() {
...
function(i) {
	...
	function t() {
			...
			e.length && e.each(function() {
				...
				d.on("tap click", function(e) {
					...
					if (t.hasClass("has_sub")) {
						...
						o.is(":visible") ? (o.slideUp(450, "easeInOutQuint"), t.removeClass("edgtf-opened")) : (t.addClass("edgtf-opened"), 0 === a.length ? t.find(".sub_menu").slideUp(400, "easeInOutQuint", function() {
		...
		function() {
			...
			if (edgtf.body.hasClass("edgtf-sticky-up-mobile-header")) {
				var o, d = i("#wpadminbar"),
					n = i(document).scrollTop();
				o = e + edgtfGlobalVars.vars.edgtfAddForAdminBar, i(window).scroll(function() {
	...
	}(edgtf.modules.mobileHeader = e).edgtfOnDocumentReady = t, i(document).ready(t)
}(jQuery),
function(g) {
	"use strict";
	var e = {};
		...
		1024 < edgtf.windowWidth && function() {
			...
			switch (!0) {
				...
				case edgtf.body.hasClass("edgtf-fixed-on-scroll"):
					...
					var f = function() {
						edgtf.scroll <= r ? (d.removeClass("fixed"), edgtf.body.removeClass("edgtf-fixed-header-appear"), a.css("margin-bottom", "0")) : (d.addClass("fixed"), edgtf.body.addClass("edgtf-fixed-header-appear"), a.css("margin-bottom", n + "px"))
					};
				...
				e.length && e.each(function() {
					u(this).on("click", function(e) {
						...
						var o = u(".edgtf-page-header"),
							...
							r = o.children(".edgtf-slide-from-header-bottom-holder"),
...
function(n) {
	...
	function t() {
		var e, d;
		e = n(".edgtf-comment-form-rating"), d = function(e, t) {
			for (var a = 0; a < e.length; a++) {
				var o = e[a];
				a < t ? n(o).addClass("active") : n(o).removeClass("active")
			}
		}, e.each(function() {
			var e = n(this),
		...
		e.length && e.each(function() {
			...
			if (e.hasClass("edgtf-accordion") && e.accordion({
				...
				var t = d(this),
					...
					o = a.next();
				t.addClass("accordion ui-accordion ui-accordion-icons ui-widget ui-helper-reset"), a.addClass("ui-accordion-header ui-state-default ui-corner-top ui-corner-bottom"), o.addClass("ui-accordion-content ui-helper-reset ui-widget-content ui-corner-bottom").hide(), a.each(function() {
					var e = d(this);
					e.hover(function() {
...
function(t) {
	...
	function a() {
		o().init()
	}(edgtf.modules.button = e).edgtfButton = o, e.edgtfOnDocumentReady = a, t(document).ready(a);
	var o = function() {
		var e = t(".edgtf-btn");
		return {
			init: function() {
...
function(p) {
	...
	function a() {
		var d, n, i, s, r, l, f, g, c, u, h, e = p(".edgtf-countdown"),
			m = (new Date).getMonth();
		e.length && e.each(function() {
			var e, t, a = p(this).attr("id"),
				o = p("#" + a);
			d = o.data("year"), n = o.data("month"), i = o.data("day"), s = o.data("hour"), r = o.data("minute"), l = o.data("timezone"), f = o.data("month-label"), g = o.data("day-label"), c = o.data("hour-label"), u = o.data("minute-label"), h = o.data("second-label"), e = o.data("digit-size"), t = o.data("label-size"), m !== n && (n -= 1), o.countdown({
...
function(r) {
	...
	function o() {
		...
		e.length && e.each(function() {
			var e = r(this),
				...
				i = "",
				s = "";
			void 0 !== e.data("item-class") && !1 !== e.data("item-class") && (t = e.data("item-class")), void 0 !== e.data("font-size-1366") && !1 !== e.data("font-size-1366") && (a += "font-size: " + e.data("font-size-1366") + " !important;"), void 0 !== e.data("font-size-1024") && !1 !== e.data("font-size-1024") && (o += "font-size: " + e.data("font-size-1024") + " !important;"), void 0 !== e.data("font-size-768") && !1 !== e.data("font-size-768") && (d += "font-size: " + e.data("font-size-768") + " !important;"), void 0 !== e.data("font-size-680") && !1 !== e.data("font-size-680") && (n += "font-size: " + e.data("font-size-680") + " !important;"), void 0 !== e.data("line-height-1366") && !1 !== e.data("line-height-1366") && (a += "line-height: " + e.data("line-height-1366") + " !important;"), void 0 !== e.data("line-height-1024") && !1 !== e.data("line-height-1024") && (o += "line-height: " + e.data("line-height-1024") + " !important;"), void 0 !== e.data("line-height-768") && !1 !== e.data("line-height-768") && (d += "line-height: " + e.data("line-height-768") + " !important;"), void 0 !== e.data("line-height-680") && !1 !== e.data("line-height-680") && (n += "line-height: " + e.data("line-height-680") + " !important;"), (a.length || o.length || d.length || n.length) && (a.length && (s += "@media only screen and (max-width: 1366px) {.edgtf-custom-font-holder." + t + " { " + a + " } }"), o.length && (s += "@media only screen and (max-width: 1024px) {.edgtf-custom-font-holder." + t + " { " + o + " } }"), d.length && (s += "@media only screen and (max-width: 768px) {.edgtf-custom-font-holder." + t + " { " + d + " } }"), n.length && (s += "@media only screen and (max-width: 680px) {.edgtf-custom-font-holder." + t + " { " + n + " } }")), s.length && (i = '<style type="text/css">' + s + "</style>"), i.length && r("head").append(i)
		})
	}
	...
	function d() {
		...
		e.length && e.each(function() {
			...
			o.length && a.push(o), d.length && a.push(d), n.length && a.push(n), i.length && a.push(i), t.appear(function() {
				e.typed({
					strings: a,
					typeSpeed: 90,
					backDelay: 700,
	...
	}(edgtf.modules.customFont = e).edgtfCustomFontResize = o, e.edgtfCustomFontTypeOut = d, e.edgtfOnDocumentReady = t, e.edgtfOnWindowLoad = a, r(document).ready(t), r(window).load(a)
}(jQuery),
function(l) {
	"use strict";
	var e = {};
...
function(m) {
	...
	function a() {
		...
		e.length && e.each(function() {
			var e, t, a, o, d, n, i, s, r, l, f = m(this),
				g = !1,
				c = "";
			...
			void 0 !== f.data("custom-map-style") && (e = f.data("custom-map-style")), void 0 !== f.data("color-overlay") && !1 !== f.data("color-overlay") && (t = f.data("color-overlay")), void 0 !== f.data("saturation") && !1 !== f.data("saturation") && (a = f.data("saturation")), void 0 !== f.data("lightness") && !1 !== f.data("lightness") && (o = f.data("lightness")), void 0 !== f.data("zoom") && !1 !== f.data("zoom") && (d = f.data("zoom")), void 0 !== f.data("pin") && !1 !== f.data("pin") && (n = f.data("pin")), void 0 !== f.data("height") && !1 !== f.data("height") && (i = f.data("height")), void 0 !== f.data("unique-id") && !1 !== f.data("unique-id") && (s = f.data("unique-id")), void 0 !== f.data("scroll-wheel") && (r = f.data("scroll-wheel")), void 0 !== f.data("addresses") && !1 !== f.data("addresses") && (l = f.data("addresses")),
				...
				}(g, c, e, t, a, o, r, d, "edgtf-map-" + s, i, n, "map_" + s, "geocoder_" + s, l)
		})
	}
...
function(i) {
	...
	function a() {
		...
		e.length && e.each(function() {
			...
			a.appear(function() {
				var e, t;
				e = d, t = parseFloat(n), e.length && e.each(function() {
					var e = i(this);
		...
		e.length && e.each(function() {
			...
			e.children(".edgtf-tab-container").each(function(e) {
				...
				var t = n(this),
					...
					d = o.attr("href"); - 1 < (a = "#" + a).indexOf(d) && o.attr("href", a)
