...
try {
    ...
    try {
        ...
        if (addPayment($data) !== false && $data['payment_status'] === 'approved') {
            ...
            header("location:http://localhost/yoinstructor2/?com=konf_payment&payid=$inserids");
            exit(1);
        } else {
            // Payment failed
			header("location:http://localhost/yoinstructor2/modul/payment/PaypalFailed.php");
             exit(1);
        }
