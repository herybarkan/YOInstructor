...
$cek_tgl=$db->prepare("SELECT * FROM payments_upgrade WHERE tgl_remind <= CURDATE() AND sts_dg='0'");
$cek_tgl->execute();
...
$mailz->setFrom('system@yoinstructor.com', 'YO Reminder');
$mailz->addReplyTo('system@yoinstructor.com', 'YO Reminder');
...
$mailz->isHTML(true);
  ...
  <tr>
    ...
    Your Profesional Account will be Expired
    </center>
    </span>
    </td>
  </tr>
