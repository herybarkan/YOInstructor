         ...
         <div class="edgtf-full-width-inner">
            <div class="edgtf-grid-row">
               <div class="edgtf-page-content-holder edgtf-grid-col-12">
                  ...
                  <div class="edgtf-row-grid-section-wrapper " style="margin-top:133px;">
...
WHERE 
(
content_search.nm_instructor LIKE '%$_POST[search_data]%' OR
content_search.address LIKE '%$_POST[search_data]%' OR
content_search.bio LIKE '%$_POST[search_data]%' OR
content_search.price LIKE '%$_POST[search_data]%' OR
content_search.category LIKE '%$_POST[search_data]%' OR
content_search.sub_category LIKE '%$_POST[search_data]%' OR
content_search.who_train LIKE '%$_POST[search_data]%' OR
content_search.where_train LIKE '%$_POST[search_data]%'
)
AND instructor.aktif='1'"); //sql select query
                           $select_stmt->execute();
