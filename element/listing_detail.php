...
<?php
$select_post=$db->prepare("SELECT * FROM tbl_post WHERE id_='$_GET[id_]'"); //sql select query
$select_post->execute();
...
<img width="80" height="80" src="https://urbango.qodeinteractive.com/wp-content/uploads/2018/08/listing-logo-img-1.png" class="attachment-thumbnail size-thumbnail" alt="a" loading="lazy"> </div>
                                       <div class="edgtf-ls-title-content">
                                       <h2 itemprop="name" class="edgtf-ls-title entry-title">Amanda</h2>
                                          
                                          <a itemprop="url" href="bprofile.php" target="_self" class="edgtf-btn edgtf-btn-large edgtf-btn-solid ">
<span class="edgtf-btn-text text-dark" style="color:#000;">Businnes Profile</span>
                                          ...
                                          <div class="edgtf-ls-title-info">
                                             <div class="edgtf-ls-listing-id">
                                                ...
                                                <span class="edgtf-ls-listing-id-value">210</span>
                                             </div>
