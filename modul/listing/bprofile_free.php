...
<script type="text/javascript" src="modul/ajax_js/update_nama2.js"></script>
...
<script type="text/javascript" src="modul/ajax_js/update_bio2.js"></script>

<script type="text/javascript" src="modul/ajax_js/update_schedule.js"></script>
<script type="text/javascript" src="modul/ajax_js/update_schedule2.js"></script>

<script type="text/javascript" src="modul/ajax_js/update_sosmed.js"></script>
<script type="text/javascript" src="modul/ajax_js/update_sosmed2.js"></script>
...
<script type="text/javascript" src="modul/ajax_js/ajax_like2.js"></script>
...
<script type="text/javascript" src="js/ajax_states2.js"></script>
<script type="text/javascript" src="js/ajax_city2.js"></script>
...
<?php
//
//include ('modul/front/layout_profile_free.php');
?>
<?php
//
$cek_inst=$db->prepare("SELECT * FROM instructor WHERE kd_instructor='$_GET[kd_inst]' AND aktif='1'"); //sql select query
   $cek_inst->execute();
   ...
   if ($row_cek_inst['id_']!="") 
	...
	{
		include ('modul/front/page_noav.php');
		}
?>
<!--================================================================================================-->
